...
public:
    ...
    void displayTime(uint8_t hour, uint8_t minute, bool block = false);
    void displaySetTime(uint8_t hour, uint8_t minute);
...
private:
    ...
    static byte       const calligraphicFont[10][5];
    static byte       const blockFont[10][5];
